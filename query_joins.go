...
func (q *Query) Join(table string, on string, args ...interface{}) *Query {
	if q.RawSQL.Fragment != "" {
		Logger.Warning("Query is setup to use raw SQL, not adding JOIN clause")
		return q
	}
...
func (q *Query) LeftJoin(table string, on string, args ...interface{}) *Query {
	if q.RawSQL.Fragment != "" {
		Logger.Warning("Query is setup to use raw SQL, not adding LEFT JOIN clause")
		return q
	}
...
func (q *Query) RightJoin(table string, on string, args ...interface{}) *Query {
	if q.RawSQL.Fragment != "" {
		Logger.Warning("Query is setup to use raw SQL, not adding RIGHT JOIN clause")
		return q
	}
...
func (q *Query) LeftOuterJoin(table string, on string, args ...interface{}) *Query {
	if q.RawSQL.Fragment != "" {
		Logger.Warning("Query is setup to use raw SQL, not adding LEFT OUTER JOIN clause")
		return q
	}
...
func (q *Query) RightOuterJoin(table string, on string, args ...interface{}) *Query {
	if q.RawSQL.Fragment != "" {
		Logger.Warning("Query is setup to use raw SQL, not adding RIGHT OUTER JOIN clause")
		return q
	}
...
func (q *Query) LeftInnerJoin(table string, on string, args ...interface{}) *Query {
	if q.RawSQL.Fragment != "" {
		Logger.Warning("Query is setup to use raw SQL, not adding LEFT INNER JOIN clause")
		return q
	}
...
func (q *Query) RightInnerJoin(table string, on string, args ...interface{}) *Query {
	if q.RawSQL.Fragment != "" {
		Logger.Warning("Query is setup to use raw SQL, not adding RIGHT INNER JOIN clause")
		return q
	}
